...
let observer = new MutationObserver((mutations) => {
    mutations.forEach((mutation) => {
        ...
        if (oldValue !== newValue) {
            //CSS checker 
            if (document.location.pathname === "/sim-only-plans" || document.location.pathname === "/acquisition/students") {
            ...
            if (document.location.pathname != "/sim-only-plans" && window.location.href.indexOf('phones/') > -1) {
                ...
                function pxPollFunc() {
                    ...
                    if (window.location.href.indexOf('voxi.co.uk/phones/basket') > -1 && document.querySelector("#root > div > div:nth-child(3) > div:nth-child(2) > div > div > div > div > div > div > button")) {
                        document.querySelector("#root > div > div:nth-child(3) > div:nth-child(2) > div > div > div > div > div > div > button").classList.add('vt850_button_1_Styling')
                        clearInterval(pxInterval);
                    }

                    //change button stylings 
                    vt850_btn_1_btn_updates()
                    ...
                    if (vt850_card.length > 1) {
                        for (var i = 0; i < vt850_card.length; i++) {
                            if (vt850_card[i].innerText.length < 10 && vt850_card[i].innerText.length > 0) {
                                //add flag styling
                                ...
                                if (vt850_btn_2) {
                                    if (!vt850_btn_2.classList.contains('vt850_button_2_Styling')) {
                                        if (vt850_btn_2.innerText == 'Log in to add device') {
...
function vt850_btn_1_btn_updates() {
